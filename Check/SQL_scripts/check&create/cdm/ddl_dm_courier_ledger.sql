...
settlement_year varchar NOT NULL CHECK (settlement_year>='2022' AND settlement_year < '2500'),
settlement_month varchar NOT NULL CHECK(((settlement_month >= '1') AND (settlement_month <= '12'))),
...
rate_avg integer NOT NULL DEFAULT 1,
